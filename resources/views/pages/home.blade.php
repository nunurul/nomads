            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h2>Our Networks</h2>
                        <p>
                            Companies area trusted us
                            <br>
                            more than just a trip
                        </p>
                    </div>
                    <div class="col-md-8 text-center">
                        <img src="{{ url('frontend/images/partnert.png') }}" alt="Logo Partner" class="img-partner">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                ...
                                <h3 class="mb-4"> Naira Latifha</h3>
                                <p class="testimonial">
                                    " The trip was amazing and 
                                    i saw something beautiful in 
                                    that island taht makes me want 
                                    to learn more"
                                </p>
                            </div>
                            <hr>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="#" class="btn btn-need-help px-4 mtt-4 mx-1">
                            I Need Help
                        </a>
                        <a href="{{ route('register') }}" class="btn btn-get-started px-4 mtt-4 mx-1">
                            Get Started
                        </a>
                    </div>
                </div>
