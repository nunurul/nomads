            ...
            <div class="col-lg-4">
                <div class="card card-details card-right">
                    ...
                    <div class="members my-2">
                        <img src="{{ url('/frontend/images/pic-1.png') }}" aclass="member-image mr-1">
                        <img src="{{ url('/frontend/images/pic-2.png') }}" aclass="member-image mr-1">
                        <img src="{{ url('/frontend/images/pic-3.png') }}" aclass="member-image mr-1">
                        <img src="{{ url('/frontend/images/pic-4.png') }}" aclass="member-image mr-1">
                        <img src="{{ url('/frontend/images/pic-5.png') }}" aclass="member-image mr-1">
                    </div>
                    <hr>
